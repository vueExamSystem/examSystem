<template>
	<div class="panel">
		<div class="title">
			<span>物理第一章预习题（2017/12/10 8:00截止）</span>
		...
		<div class="content">
			...
			<div class="paper-progress">
				<table>
					...
					<tr>
						<td>未开始预习</td>
						<td><el-progress :percentage="10" :stroke-width="12"></el-progress></td>
						<td></td>
						<td></td>
					</tr>
				</table>
...
<script>
    ...
    import {getExampleDetailList, getExampleDetailFilter} from '../../../api/api';
	...
	export default{
		...
		methods:{
            ...
            getList() {
                ...
                getExampleDetailList(para).then((res) => {
                    res=res.data;
            ...
            getFilter() {
                ...
                getExampleDetailFilter({}).then((res) => {
