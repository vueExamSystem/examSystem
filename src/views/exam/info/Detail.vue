<template>
    <div class="panel">
        ...
        <div class="content">
            <my-filter v-if="filterList.length > 0" :list="filterList" @callback="search"
                       v-loading="filterLoading"></my-filter>
            <div class="paper-progress">
                <table>
                    <tr>
                        <td>已完成比例</td>
                        <td>
                            <el-progress :percentage="60" :stroke-width="12"></el-progress>
                        </td>
                        <td>在线人数/不在线/总人数</td>
                        <td>25/5/30</td>
                    </tr>
                    <tr>
                        <td>已交卷比例</td>
                        <td>
                            <el-progress :percentage="70" :stroke-width="12"></el-progress>
                        </td>
                        <td>考试总体平均答题</td>
                        <td>
                            <el-progress :percentage="60" :stroke-width="12"></el-progress>
                    ...
                    <tr>
                        <td>未开始答卷</td>
                        <td>
                            <el-progress :percentage="1" :stroke-width="12"></el-progress>
                        </td>
                        <td></td>
                        <td></td>
                    </tr>
