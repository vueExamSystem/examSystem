		...
		<div class="panel">
			...
			<div class="content">
				<el-form ref="form" :model="form" :rules="rules" label-width="110px" :inline-message="isInlineMessage" @submit.prevent="onSubmit">
					...
					<el-form-item label="选择试卷：" prop="test"> 
						<el-select v-model="form.test" placeholder="请选择试卷">
					...
					<el-form-item label="考试院系：" prop="department">
						<el-select v-model="form.department" placeholder="请选择考试院系">
					...
					<el-form-item label="考试班级：" prop="class">
						<el-select v-model="form.class" placeholder="请选择考试班级">
