            ...
            <div class="panel" v-if="isInited">
                ...
                <div class="content">
                    <el-table :data="papers" highlight-current-row v-loading="listLoading" style="width: 100%;">
                        ...
                        <el-table-column prop="name" label="练习题名称" min-width="100">
...
<!--                         <el-table-column prop="project" label="所属课程" min-width="120">
                ...
                <el-dialog title="编辑试卷" :visible.sync="editFormVisible">
                    <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm" :inline-message="isInlineMessage" v-loading="editLoading">
                        <el-form-item label="练习题名称" prop="name">
...
<script>
    ...
    import { getSubjectList, getTrainFilter, getTrainList, eidtTrain, removeTrain,copyTrain } from '../../../api/api';
